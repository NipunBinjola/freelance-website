        ...
        <div>
            ...
            <div className="jumbotron jumbotron-fluid bg-dark text-light">
                <div className="container">
                    <h1 className="display-4">Job Wolf</h1>
                    <p className="lead">The ultimate freelance platform around the globe, Our AI assists you in your journey</p>

                    <div className="align-items-center text-center my-5">
                        <h2 className="py-3">Ready to get hassel free Job?</h2>
                        <button className="btn btn-lg btn-warning text-light" data-toggle="modal" >Login Now !!!</button>

                        <h4 className="text-center mt-5">Want to understand AI Embeddings? <a className="text-decoration-none" href="http://saurass.in" target="_blank"><span className="contact-me">Contact me !</span></a></h4>
            ...
            <div className="container">
                <div className="row">
                    <div className="col-md-6 col-sm-12 justify-content-center">
                        <h2>We connect the Best match</h2>
                        ...
                        <ul className="hideBulletInli">
                            ...
                            <li className="d-flex align-items-center my-4">
                                ...
                                <span>AI assistant just for you</span>
                            </li>
                            ...
                            <li className="d-flex align-items-center my-4">
                                ...
                                <span>Smart Algorithm for best match</span>
                            </li>
