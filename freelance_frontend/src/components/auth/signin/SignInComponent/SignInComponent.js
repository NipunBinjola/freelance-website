                    ...
                    <div className="card-body">
                        <div className="row justify-content-center align-content-center py-4">
                            ...
                            <div className="d-inline-block ml-2">
                                ...
                                <span className="d-block" >Emerging AI Job Portal</span>
                            </div>
                        </div>
                        ...
                        <div className="form-group">
                            ...
                            <div className="input-group">
                                <input type="text" className="form-text form-control" onChange={handlechange("username")} placeholder="Email" name="username" />
                            </div>
                        </div>
                        <div className="form-group">
