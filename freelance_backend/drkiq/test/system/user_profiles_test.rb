...
class UserProfilesTest < ApplicationSystemTestCase
  ...
  test "should create user profile" do
    ...
    fill_in "About", with: @user_profile.about
    fill_in "Experiences", with: @user_profile.experiences
    fill_in "Pricing", with: @user_profile.pricing
    fill_in "Skills", with: @user_profile.skills
    fill_in "Social links", with: @user_profile.social_links
